...
define('BASE_URL', 'http://169.239.251.102:442/~reindorf.narh/skilloffice/web-app'); 

//local 
// define('APP_URL', 'localhost/skilloffice/web-app');
// define('BASE_URL', 'localhost/skilloffice/web-app'); 
